...
class _InstructorReportsContentState extends State<InstructorReportsContent>
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: const TextStyle(
                              fontFamily: 'Almarai', fontSize: 13),
          ...
          child: _isLoading
              ...
              : _error != null
                  ...
                  : TabBarView(
                      controller: _tabController,
                      children: [
                        _buildReportsList(_courseReports, true, isDark),
                        _buildReportsList(_reviewReports, false, isDark),
                      ],
                    ),
        ),
      ],
  ...
  Widget _buildHeader(bool isDark) {
    final pending =
        _courseReports.where((r) => r['status'] == 'pending').length +
  ...
  Widget _buildReportsList(
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) => _buildReportCard(reports[i], isCourse, isDark),
      ),
    );
  }
