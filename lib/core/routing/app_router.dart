...
import 'package:lms_platform/core/shared_widgets/report_screen.dart';
// Splash
import 'package:lms_platform/features/student/splash/presentation/screens/splash_screen.dart';
// Notifications
import 'package:lms_platform/features/student/notifications/presentation/cubit/notifications_cubit.dart';
import 'package:lms_platform/features/student/notifications/presentation/screens/notifications_screen.dart';
// Categories
import 'package:lms_platform/features/student/categories/presentation/screens/categories_screen.dart';
// Q&A
import 'package:lms_platform/features/student/qa/presentation/screens/qa_screen.dart';
import 'package:lms_platform/features/student/qa/presentation/screens/ask_question_screen.dart';
// Auth
...
import 'package:lms_platform/features/student/auth/presentation/screens/login_screen.dart';
import 'package:lms_platform/features/student/auth/presentation/screens/forgot_password_screen.dart';
import 'package:lms_platform/features/student/auth/presentation/screens/reset_password_screen.dart';
import 'package:lms_platform/features/student/auth/presentation/screens/interests_selection_screen.dart';
import 'package:lms_platform/features/student/teacher_selection/presentation/screens/select_teacher_screen.dart';
// Main
import 'package:lms_platform/features/student/main/presentation/screens/main_screen.dart';
// Home
import 'package:lms_platform/features/student/home/presentation/screens/home_screen.dart';
import 'package:lms_platform/features/student/home/presentation/screens/courses_list_screen.dart';
import 'package:lms_platform/features/student/home/domain/entities/course_entity.dart'
    as home;

// My Learning
import 'package:lms_platform/features/student/my_learning/presentation/screens/my_learning_screen.dart';
// History
import 'package:lms_platform/features/student/history/presentation/screens/history_screen.dart';
// Forums
import 'package:lms_platform/features/student/course_forum/presentation/screens/forums_list_screen.dart';
import 'package:lms_platform/features/student/course_forum/presentation/screens/forum_chat_screen.dart';
import 'package:lms_platform/features/student/course_forum/presentation/screens/course_forums_management_screen.dart';

// Wishlist
import 'package:lms_platform/features/student/wishlist/presentation/screens/wishlist_screen.dart';
import 'package:lms_platform/features/student/wishlist/presentation/cubit/wishlist_cubit.dart';
// Profile
import 'package:lms_platform/features/student/settings/presentation/screens/profile_screen.dart';
import 'package:lms_platform/features/student/settings/presentation/cubit/settings_cubit.dart';
import 'package:lms_platform/features/student/settings/presentation/screens/settings_screen.dart';
import 'package:lms_platform/features/student/settings/presentation/screens/help_support_screen.dart';
import 'package:lms_platform/features/student/settings/presentation/screens/edit_profile_screen.dart';
import 'package:lms_platform/features/student/settings/presentation/screens/terms_of_service_screen.dart';
import 'package:lms_platform/features/student/settings/presentation/cubit/profile_cubit.dart';
import 'package:lms_platform/features/student/settings/presentation/screens/student_profile_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/students_progress_sheet_screen.dart';
// Course Search
import 'package:lms_platform/features/student/course_search/presentation/cubit/course_search_cubit.dart';
import 'package:lms_platform/features/student/course_search/presentation/screens/course_search_screen.dart';
import 'package:lms_platform/features/student/course_search/presentation/screens/course_filter_screen.dart';
...
import 'package:lms_platform/features/student/payments_history/presentation/screens/payments_history_screen.dart';
// Course Details
import 'package:lms_platform/features/student/course_details/presentation/cubit/course_details_cubit.dart';
import 'package:lms_platform/features/student/course_details/presentation/screens/course_details_screen.dart';
// Cart & Checkout
...
import 'package:lms_platform/features/student/cart/presentation/screens/cart_screen.dart';
import 'package:lms_platform/features/student/cart/presentation/screens/checkout_screen.dart';
import 'package:lms_platform/features/student/cart/presentation/screens/payment_success_screen.dart';
...
import 'package:lms_platform/features/student/course_player/presentation/screens/course_player_screen.dart';
import 'package:lms_platform/features/student/course_player/presentation/screens/attachment_preview_screen.dart';
// Quizzes
import 'package:lms_platform/features/student/quizzes/presentation/cubit/quiz_cubit.dart';
import 'package:lms_platform/features/student/quizzes/presentation/screens/quiz_info_screen.dart';
import 'package:lms_platform/features/student/quizzes/presentation/screens/quiz_question_screen.dart';
import 'package:lms_platform/features/student/quizzes/presentation/screens/quiz_results_screen.dart';
...
import 'package:lms_platform/features/admin_dashboard/presentation/screens/admin_dashboard_screen.dart';
import 'package:lms_platform/features/admin_dashboard/presentation/screens/ban_user_screen.dart';
import 'package:lms_platform/features/admin_dashboard/presentation/screens/course_details_screen.dart'
    as admin_course;
import 'package:lms_platform/features/admin_dashboard/presentation/screens/course_enrollments_screen.dart'
    as admin_course_enrollments;
import 'package:lms_platform/features/admin_dashboard/presentation/screens/user_details_screen.dart';
...
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/student_details_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/student_progress_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/send_message_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/student_enrollments_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/quiz_attempts_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/quiz_response_details_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/coupon_editor_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/earnings_history_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/quiz_editor_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/create_quiz_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/quiz_questions_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/quiz_preview_screen.dart';
...
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/category_editor_screen.dart';
import 'package:lms_platform/features/instructor_dashboard/presentation/screens/banner_editor_screen.dart';
...
import 'package:lms_platform/features/student/instructor/presentation/cubit/instructor_cubit.dart';
import 'package:lms_platform/features/student/instructor/presentation/screens/instructor_profile_screen.dart';
